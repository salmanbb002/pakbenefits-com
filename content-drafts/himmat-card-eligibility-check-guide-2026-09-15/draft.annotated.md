# How to Check Himmat Card Eligibility and Status by CNIC (2026)

Check your **Himmat Card** status at the official **DPMIS** verification page (dpmis.punjab.gov.pk) by entering your 13-digit **CNIC** — no login needed. Eligibility itself depends on a certified **disability**, a **BISP** **PMT score** of 45 or below, and not already receiving BISP, PSPA, Zakat, or Bait ul Maal assistance.

## What Is the Himmat Card, and Who Runs It?
...
### Himmat Card vs Other Punjab and BISP Support
...
### How the PMT Score and BISP Fit In
...
## How Do I Check My Himmat Card Status Online by CNIC?
...
1. Open dpmis.punjab.gov.pk on a phone or computer.
2. Go to the Himmat Card verification section.
3. Type your 13-digit CNIC without dashes.
4. Submit to view your status.

This public verification step is separate from the DPMIS registration/login system described later in this guide — you don't need an account or password just to check an existing status.

### Checking Without Internet Access

If you can't use the DPMIS portal, call the Himmat Card **helpline 1312** or visit your **District Social Welfare Office** in person with your original CNIC. Staff there can look up your status directly and tell you what, if anything, is missing from your file.

## Is Himmat Card Checked Through 8171?
...
## What Do the Status Results Mean?
...
## How Do I Register If I'm Not Yet in the System?
...
1. Visit dpmis.punjab.gov.pk and select the registration option.
2. Enter your full name, CNIC, phone number, and B-Form/**NADRA** details if applying for a child.
3. Select your division, district, and medical board for the disability assessment.
4. Set a password, complete the captcha, and submit.

Keep a valid, unexpired CNIC and updated contact number on file — an expired CNIC is one of the most commonly reported reasons a otherwise-eligible case stalls after registration.

## How Much Does It Pay, and How Do I Check My Balance?
...
| What you want to know | Where to check | What you need | What it shows |
|---|---|---|---|
...
## What's New in the Himmat Card Program (September 2026)?
...
## How Do I Avoid a Fake Himmat Card Site or Agent?
...
It's a Punjab Social Welfare Department card giving eligible persons with disabilities Rs 10,500 every three months, administered through the DPMIS system.

**How do I check my Himmat Card eligibility by CNIC?**
Go to dpmis.punjab.gov.pk, open the Himmat Card verification section, enter your 13-digit CNIC without dashes, and submit — no account or password is needed for this check.

**Is Himmat Card checked through 8171?**
No. Neither official Punjab source for this program mentions 8171; that number belongs to BISP's own separate household-eligibility check.

**What PMT score do I need for the Himmat Card?**
Your BISP-issued Proxy Means Test score must be 45 or below. This is the same PMT figure BISP uses for its own programmes, not a separate disability-specific score.

**Can I get a Himmat Card if I already receive BISP or Zakat?**
No. Current BISP, PSPA, Zakat, or Bait ul Maal assistance disqualifies an applicant from the Himmat Card, according to the official eligibility criteria.

**What does "under review" mean on my status check?**
It means your record has been submitted but is still being processed by the Social Welfare Department; check again after some time rather than resubmitting your CNIC repeatedly.

**How much does the Himmat Card pay, and how is it delivered?**
Rs 10,500 every three months, paid onto a Bank of Punjab ATM card rather than handed out as cash at an office.

**How do I check my Himmat Card balance?**
Use your Bank of Punjab ATM card and PIN at any Bank of Punjab ATM's balance-inquiry option; this is separate from the CNIC-based DPMIS eligibility check.

**How do I register if my CNIC shows "not found"?**
Create a new account on dpmis.punjab.gov.pk with your CNIC, contact details, and a selected medical board for your disability assessment, then submit for review.

**Can a child with a disability get a Himmat Card?**
Yes — a parent or guardian can apply and manage the card on the child's behalf; there's no separate age limit stated in the published criteria.

**Is the Himmat Card program guaranteed to continue through 2026?**
The official DPMIS FAQ describes the program as "approved until June 2025" with an extension pending review, so ongoing availability should be confirmed through official channels rather than assumed indefinitely.

**Can I check my Himmat Card status without internet?**
Yes — call the 1312 helpline or visit your District Social Welfare Office in person with your original CNIC.

**Is there a fee to check status or register?**
No. Both the status check and registration are free; never pay anyone claiming to speed up or guarantee approval.

## Official Sources

- [Himmat Card FAQs — DPMIS Punjab](https://dpmis.punjab.gov.pk/faqs)
- [Himmat Card — Social Welfare Department, Government of the Punjab](https://swd.punjab.gov.pk/himmatcard)

---

**Unused tier-3 terms (honest-oversight log):** NADRA is used once (documents step) rather than
expanded, since its role here is limited to B-Form issuance for a child applicant — expanding it
further would drift into general NADRA mechanics already covered by `/cnic-verification-guide/`.
