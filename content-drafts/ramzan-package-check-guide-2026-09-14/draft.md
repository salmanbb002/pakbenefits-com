# Ramzan Package Check: Is It 8171, 9999, or a Different Number?

The Ramzan Package usually refers to the Prime Minister's Ramzan Relief Package, run by the National Information Technology Board (NITB) and checked through its official portal or by sending a CNIC to 9999 — not through BISP's 8171 number. Eligibility draws mainly on existing NSER and BISP records, so most people are not filling out a fresh application.

That single sentence is also where most confusion online starts. Several ranking pages brand this same check as "8171," others as "9999," and at least one lists four different short codes for four different programs. This guide checks that claim against the official portal directly, walks through the actual check methods, and flags where the ranking pages disagree so you are not guessing which one to trust.

## What Is the Ramzan Package, and Who Runs It?
...
### Prime Minister's Package vs a Province's Own Package
...
## Is It Checked Through 8171, 9999, or Another Number?
...
## How Do I Check My Ramzan Package Status by CNIC?
...
3. Send it to **9999**.
4. Wait for a reply message confirming your status.

### Online Portal Method

1. Go to the official portal at pmrrp.nitb.gov.pk.
2. Enter your CNIC number.
3. Complete the CAPTCHA verification.
4. Submit the form to see your result.
...
## Who Is Eligible for the Ramzan Package?
...
## How Much Does It Pay, and How Is It Sent?
...
## Why Do 8171, 9999, and 8070 Get Confused With Each Other?
...
## How Do I Avoid a Fake Ramzan Package Site or Agent?
...
**Is the Ramzan Package the same as BISP's 8171 service?**
No. BISP is a separate program with its own established 8171 number, even though the Ramzan Package draws on some of the same underlying NSER data. Several pages online conflate the two because 8171 is more widely recognized.

**Why do different websites give different numbers for the same check?**
Because this program doesn't have one single, universally cited authoritative source that every content site checks against — some default to BISP's more recognizable 8171 number, while others follow the 9999 code that's consistent with the official portal's own domain pattern.

**How can I check my eligibility?**
Send your 13-digit CNIC to 9999 by SMS, or enter it on the official pmrrp.nitb.gov.pk portal with the CAPTCHA verification.

**Is there a registration fee?**
No. The eligibility check itself is free; standard network SMS charges from your provider may still apply.

**Can I apply without a CNIC?**
No — a valid Computerized National Identity Card is required for either check method.

**How much financial assistance is given?**
Commonly reported figures are Rs 13,000 for the federal package and Rs 10,000 for provincial variants, though these were not visible on the official portal excerpt reviewed for this guide — confirm the current figure before relying on it.

**Can I apply online for the Ramzan Package?**
Most people don't need to apply separately — eligibility is generally drawn from existing NSER or BISP records. If you've never registered with either, that's the step to complete first.

**How long does it take to get a reply?**
Most SMS and portal checks return a result within minutes, though delays are reported during high-traffic periods.

**Is registration required for everyone?**
No. Most applicants are checked automatically against existing NSER or BISP data rather than registering from scratch.

**Can I use someone else's CNIC or SIM?**
No. Both methods require your own valid CNIC and a SIM registered in your own name.

**How will I receive the payment after approval?**
Reported channels include bank transfer, ATM withdrawal with biometric verification, mobile wallets, or designated government cash centers — verify the specific method through the official channel once your status shows eligible.

**Can government employees apply?**
Regular government employees are generally excluded from eligibility, according to the criteria described across the sources reviewed.

**Is the Ramzan Package still open in September 2026?**
The most recent cycle covered Ramadan 2026 (February–March), which has already ended. A new cycle is expected to be announced closer to the next Ramadan rather than remaining open year-round.
