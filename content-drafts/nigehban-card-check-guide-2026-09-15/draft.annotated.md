# Nigehban Card Check Online by CNIC: How to Check Your Status (2026)

The **Nigehban Card** — Punjab's Ramzan relief card — is checked by sending your 13-digit **CNIC** by SMS to **8070**, or by logging in with your CNIC on the **PSER** portal at pser.punjab.gov.pk. It's a Punjab provincial scheme run through the **Punjab Socio-Economic Registry**, and it's separate from BISP's 8171 and the federal Ramzan Relief Package's **9999** code.

## What Is the Nigehban Card, and Who Runs It?

The **Nigehban Card** is the **Government of Punjab**'s own Ramadan relief initiative, publicly announced by **Chief Minister Maryam Nawaz Sharif** and described in an official release from the Directorate General of Public Relations, Punjab, as the "Nigehban Ramzan Package." The Chief Minister's own **CM Special Monitoring Unit** refers to the same initiative as the "CM Nigehban Card Program for Destitute and Vulnerable" families — the two names describe one programme, not two competing ones, which resolves a genuine source of confusion in how this scheme gets searched for.
...
### A Repeat Programme, Not a One-Off
...
## Is the Nigehban Card the Same as BISP's 8171 or the Federal Ramzan Package?
...
| Programme | Run by | Registry it draws from | Reported SMS code |
|---|---|---|---|
...
## How Do I Check My Nigehban Card Status by CNIC?
...
## What Happens After You Check, and What If You're Not Eligible?
...
## How Do I Avoid a Fake Nigehban Card Site or Agent?
...
## What's True Right Now (September 2026)?
...
**Is the Nigehban Card the same as the CM Nigehban Card Program?**
Yes. Punjab's own Special Monitoring Unit describes the "CM Nigehban Card Program for Destitute and Vulnerable" and the "Nigehban Ramzan Package" as the same initiative, even though both names circulate separately online.

**Is the Nigehban Card the same as BISP's 8171 service?**
No. BISP is a separate federal programme with its own registry and its own 8171 number. The Nigehban Card draws instead on Punjab's own PSER data.

**How do I check my Nigehban Card status?**
Send your 13-digit CNIC by SMS to 8070, or enter your CNIC on the official portal at pser.punjab.gov.pk.

**Why do some websites say the code is 9999 instead of 8070?**
9999 is actually the code for a different, federal scheme — the PM Ramzan Relief Package. A minority of guides mislabel that code as Nigehban's own, and at least one also wrongly adds BISP's separate Kafaalat payment into the total.

**How much money does the Nigehban Card provide?**
Commonly reported figures put it at a one-time Rs 10,000 via an ATM-style card, plus a subsidized rashan package — though the exact rashan quantities are third-party reported, not confirmed on Punjab's own pages.

**Do I need to register separately for the Nigehban Card?**
No. There is no separate Nigehban Card application form; eligibility is drawn entirely from your existing PSER household record, so registering with PSER (if you haven't already) is the actual prerequisite.

**What is PSER, and how is it different from NSER?**
PSER is the Punjab Socio-Economic Registry, Punjab's own provincial household-data survey. NSER is the federal registry BISP uses. They are run by different authorities and are not the same database.

**Who is eligible for the Nigehban Card?**
Reported criteria include Punjab residency, a valid CNIC, monthly household income under Rs 60,000, and a PMT score below 32, with priority often given to households already flagged through PSER or BISP as low-income.

**Who is excluded from the Nigehban Card?**
Regular government employees, households owning more than about two acres of agricultural land, and CNIC/SIM mismatches are the exclusions cited most consistently across sources.

**What does "under verification" mean after I check?**
It means your PSER record needs to be checked or updated before a final result is issued — it is not a rejection.

**Is the Nigehban Card still open in September 2026?**
The 2026 cycle's reported registration cutoff was mid-February 2026, ahead of that year's Ramadan, so the window described by most current guides has already closed as of this update.

**Is there a fee to check or register for the Nigehban Card?**
No. The check itself is free; only standard network SMS charges from your own provider may apply.

**How will I receive the Nigehban Card payment?**
Reported channels include HBL Konnect agents, UBL Omni centers, designated bank ATMs, and branchless banking agents, with CNIC verification required at collection.

---

**Unused tier-3 terms (honest-oversight):** none withheld — all tier-3 terms (Rs 47 billion
budget, 4.2 million families, rashan quantities, 24–72 hour payment window) were used at
least once, clearly attributed as third-party reported.
