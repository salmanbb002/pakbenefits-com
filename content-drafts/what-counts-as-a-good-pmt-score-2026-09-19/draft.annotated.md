...
For **BISP**, a good **PMT score** is **32 or below** on the **Proxy Means Test** scale, where a lower number means greater financial need. A relaxed cut-off of **37** applies to households with a certified **differently-abled** member. A score above the applicable cut-off is normally outside **Benazir Kafaalat** eligibility.
...
## What Is a PMT Score, and What Does It Measure?
...
### How the NSER Survey Produces Your Score
...
### Why a Lower PMT Score Means Stronger Eligibility
...
### The Standard BISP Cut-Off: 32 or Below
...
### The Relaxed 37 Cut-Off for Households With a Disability
...
### PMT Score Bands and What Each Band Means

| PMT score band | What it generally indicates | Practical meaning for BISP |
|---|---|---|
| 0–32 | Deepest recorded poverty | Within the standard Benazir Kafaalat threshold |
| 33–37 | Low income, above the standard cut-off | May qualify only under the relaxed disability rule |
| 38–50 | Moderate recorded stability | Normally outside Kafaalat; some provincial schemes use their own limits |
| 51–100 | Higher recorded stability | Generally outside core BISP cash support |
...
## How to Check Your PMT Score Online by CNIC (8171)
...
### Method 1: The 8171 Web Portal, Step by Step

1. Open the official portal at 8171.bisp.gov.pk and check the address before typing anything.
2. Enter your 13-digit CNIC without dashes or spaces.
3. Complete the image code (captcha) shown on the page.
4. Submit the form and read the entire result, including any instruction it gives.
...
### What the 8171 Result Shows — and What It Does Not
...
## Is a "Good" Score the Same for Every Programme?
...
### Provincial Schemes and Utility Subsidies
...
## Why Your PMT Score Is Missing or Looks Wrong
...
### Common Causes of a Missing or Outdated Record
...
### How to Request a Correction or Re-Survey
...
## What Changed in 2026: A Dated Reference Table
...
| Item | Current reference | Date / source basis |
|---|---|---|
| Kafaalat quarterly payment | **Rs 14,500** (raised from Rs 13,500) | Announced February 2026; PID briefing 22 June 2026 |
| Planned further increase | Announced for January 2027 | PID briefing 22 June 2026 |
| Standard PMT threshold | 32 or below | BISP programme practice |
| Relaxed threshold | 37 with certified disability | BISP programme practice |
| NSER registry size | About 35 million households | BISP NSER update completed 2019–2021 |
| Beneficiary recertification | After three years | BISP NSER dynamic registry cycle |
...
### What is a good PMT score for BISP?

A good PMT score for BISP is 32 or below, because BISP assistance targets households with the lowest recorded welfare. Lower scores indicate greater financial need and a stronger position within the eligibility threshold.

### What is the maximum PMT score to qualify for Benazir Kafaalat?

The standard threshold is 32. Households with a certified differently-abled member are assessed against a relaxed threshold of 37. Meeting the threshold is necessary, but BISP also applies its own verification checks.

### Does the 8171 portal always show my exact PMT score?

No. The official route shows available household eligibility and status information, and a numeric score is not guaranteed to appear. If you need the recorded detail, ask BISP through its official desk or helpline.

### How do I check my PMT score online by CNIC?

Enter your 13-digit CNIC on the official 8171 portal at 8171.bisp.gov.pk and complete the captcha, or send your CNIC by SMS to 8171 from a SIM registered in your name.

### What does a PMT score between 33 and 37 mean?

It is above the standard cut-off but inside the relaxed disability threshold. A household in this band may qualify only if it includes a certified differently-abled member, and BISP decides each case on its verified record.

### Can a PMT score change over time?

Yes. A score can change after an approved household update, after recertification, or when cross-checks against other official records reveal a change in recorded circumstances. Beneficiaries undergo recertification on BISP's cycle, which its NSER documentation describes as after three years.

### Can I check my PMT score without a CNIC?

No. The household record is linked to a CNIC, so the 8171 check requires the applicant's 13-digit CNIC. A family member cannot check another adult's record without that person's identity number.

### How do I fix a wrong PMT score?

Take the specific error to a BISP Tehsil Office with your original CNIC and supporting documents, and ask which correction or re-survey process applies. If the error is in your NADRA identity record, correct that first.

### Can I lower my PMT score by hiding assets?

No. Deliberately false information is treated as fraud, and BISP cross-checks household data against national databases. Only genuine changes in circumstances should be reported through the authorized process.

### Is a good PMT score the same for every government programme?

No. Other programmes, including provincial schemes and utility subsidies, can set their own thresholds even when they use the same NSER data. Confirm the current rule with the department responsible for that programme.

---

## Per-section unused-term notes (tier 3)

- **PSER / Punjab Socio-Economic Survey** — parked. Belongs to the provincial ration-card mechanism; mentioning it by name risks implying this article is the PSER guide. Covered at concept level under "Provincial Schemes and Utility Subsidies".
- **Ehsaas Emergency Cash / utility store subsidy / Apna Ghar** — parked as example programmes. The section explains that other programmes set their own thresholds; naming each scheme would pull toward separate search intents.
- **"8171 by preparation point"** — parked (dedupe log, Step 6). Navigational/brand query for a third-party site, not a BISP PMT concept; cannot be served honestly by this article.
- **BISP Digital Wallet / Benazir SIM** — parked. Payment-mechanism intent; belongs to `/payment-check/` cluster, not the PMT score article.
- **Taleemi Wazaif / Nashonuma** — parked. Separate programme records; linking to their hubs is sufficient.
- **Biometric / B-Form** — used once in the correction checklist; deeper treatment belongs to the registration guides.
